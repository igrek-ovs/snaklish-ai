...
export class ManageCategoriesComponent implements OnInit {
  ...
  public get isAnyFilterApplied() {
    return (
      ...
      this.form.controls['searchBy'].value !== CategorySearchBy.NAME
    );
  }
  ...
  ngOnInit(): void {
    this.form.valueChanges
      .pipe(
        debounceTime(300),
        distinctUntilChanged(
          (a, b) => a.search === b.search && a.searchBy === b.searchBy && a.category === b.category
        ),
        ...
        .pipe(
          ...
          switchMap((req) =>
            this.categoriesService
              .updateCategory(cId, { name: req.name, description: req.description })
              .pipe(
                this.hotToastService.observe({
